package br.com.erik.springboot.integration;
...
import br.com.erik.springboot.wrapper.PageableResponse;
...
class AnimeControllerIT {
    ...
    private static final DevUser USER = DevUser.builder()
            .name("Erik")
            .password("{bcrypt}$2a$10$3MoRRvYuH30ikGHoEVU77O2hgBJnCSgcgR206QUYVWZLbhfzDXLtu")
            .username("erik")
